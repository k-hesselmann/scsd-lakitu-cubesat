...
| Baro cross-check | C6 | GNSS absolute altitude vs reconstructed barometric pressure altitude disagreement | 5 s | EQUIPMENT_BARO | baro reinit | CDH | FSM prefers GPS altitude |
