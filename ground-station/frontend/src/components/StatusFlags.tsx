...
import { EQUIPMENT_BARO, EQUIPMENT_CORAL, EQUIPMENT_EPS_ADC, EQUIPMENT_GPS, EQUIPMENT_IMU, EQUIPMENT_LORA, EQUIPMENT_SD, gnssFixIsValid, hasEquipmentFault, rawFlagIsValid } from "@/lib/telemetryHealth"
...
export function StatusFlags({ latest }: { latest: TelemetryRow | null }) {
  ...
  const flags = [
    ["GNSS 3D fix valid", gnssFixIsValid(latest), false], ["IMU valid", rawFlagIsValid(latest.imu_valid_raw), false],
