...
\href{\repourl}{\texttt{scsd-lakitu-cubesat}} repository
(\href{\repourl}{\repourl}). Requirement identifiers cited throughout
(for example MR-002, FR-016, IF-008) refer to the mission and subsystem
requirements specification reproduced in Appendix~\ref{app:requirements}.
...
Konstantin Hesselmann & EPS, Payload & OBC, Structures \\
\bottomrule
\end{tabular}
