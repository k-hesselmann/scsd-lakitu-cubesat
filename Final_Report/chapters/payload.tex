...
\textit{Code, trained models, and training pipeline for this chapter live
under \href{\repourl/tree/main/payload}{\texttt{payload/}} in the
...
\href{\repourl/blob/main/payload/coral/models/cloud_regressor_qat_int8_edgetpu.tflite}{\texttt{payload/coral/models/cloud\_regressor\_qat\_int8\_edgetpu.tflite}}
(an exception to the repo's usual \texttt{*.tflite} ignore rule) so the
firmware builds without regenerating the model.
...
\midrule
Raw imagery & 95-Cloud / 38-Cloud dataset
(\href{\repourl/tree/main/payload/data}{\texttt{payload/data/}}, not
tracked) \\
Class dataset build &
\href{\repourl/blob/main/payload/training/build_cloud_classes.py}{\texttt{training/build\_cloud\_classes.py}}
\\
Training &
\href{\repourl/blob/main/payload/training/notebooks/train_cloud_regressor.ipynb}{\texttt{training/notebooks/train\_cloud\_regressor.ipynb}}
(Keras) \\
Quantization & QAT $\rightarrow$ int8 TFLite \\
Edge TPU compile & \texttt{edgetpu\_compiler} \\
Flight artifact &
\href{\repourl/tree/main/payload/coral/models}{\texttt{coral/models/*\_edgetpu.tflite}}
(tracked) \\
\bottomrule
\end{tabular}
\end{center}
...
The flight firmware
(\href{\repourl/blob/main/payload/coral/src/cloud_regressor.cc}{\texttt{payload/coral/src/cloud\_regressor.cc}})
is an
...
is flagged in
\href{\repourl/blob/main/payload/coral/docs/TODO.md}{\texttt{docs/TODO.md}}
for removal before flight and does not
...
Specification in
\href{\repourl/blob/main/interface_docs/UART_PROTOCOL.md}{\texttt{interface\_docs/UART\_PROTOCOL.md}},
not reproduced here.
